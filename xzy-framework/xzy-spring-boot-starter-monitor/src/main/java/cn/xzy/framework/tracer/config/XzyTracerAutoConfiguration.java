...
import cn.xzy.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "xzy.tracer", value = "enable", matchIfMissing = true)
public class XzyTracerAutoConfiguration {
