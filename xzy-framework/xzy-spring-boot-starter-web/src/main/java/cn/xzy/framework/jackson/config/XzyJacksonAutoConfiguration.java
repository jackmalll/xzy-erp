package cn.xzy.framework.jackson.config;

import cn.xzy.framework.common.util.json.JsonUtils;
import cn.xzy.framework.common.util.json.databind.NumberSerializer;
import cn.xzy.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import cn.xzy.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class XzyJacksonAutoConfiguration {
