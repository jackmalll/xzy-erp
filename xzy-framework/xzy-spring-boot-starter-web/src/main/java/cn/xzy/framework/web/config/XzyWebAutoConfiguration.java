package cn.xzy.framework.web.config;
...
import cn.xzy.framework.web.core.filter.CacheRequestBodyFilter;
import cn.xzy.framework.web.core.filter.DemoFilter;
import cn.xzy.framework.web.core.handler.GlobalExceptionHandler;
import cn.xzy.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class XzyWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "xzy.demo", havingValue = "true")
