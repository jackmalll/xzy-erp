package cn.xzy.module.infra.service.logger;
...
import cn.xzy.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.xzy.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.xzy.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.xzy.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.xzy.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.xzy.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        reqVO.setApplicationName("xzy-test");
