package cn.xzy.module.system.service.user;
...
import cn.xzy.framework.common.util.collection.ArrayUtils;
import cn.xzy.framework.common.util.collection.CollectionUtils;
import cn.xzy.framework.test.core.ut.BaseDbUnitTest;
import cn.xzy.module.infra.api.config.ConfigApi;
import cn.xzy.module.infra.api.file.FileApi;
import cn.xzy.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.xzy.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.xzy.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.xzy.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.xzy.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.xzy.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import cn.xzy.module.system.dal.dataobject.dept.DeptDO;
import cn.xzy.module.system.dal.dataobject.dept.PostDO;
import cn.xzy.module.system.dal.dataobject.dept.UserPostDO;
import cn.xzy.module.system.dal.dataobject.tenant.TenantDO;
import cn.xzy.module.system.dal.dataobject.user.AdminUserDO;
import cn.xzy.module.system.dal.mysql.dept.UserPostMapper;
...
import cn.xzy.module.system.service.dept.PostService;
...
import static cn.xzy.framework.common.util.collection.SetUtils.asSet;
import static cn.xzy.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.xzy.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.xzy.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.xzy.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.xzy.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.xzy.framework.test.core.util.RandomUtils.*;
import static cn.xzy.module.system.enums.ErrorCodeConstants.*;
import static cn.xzy.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("xzyyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("xzyyuanma");
        ...
        assertEquals("xzyyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("xzyyuanma"))).thenReturn("java");
