package cn.xzy.module.system.service.social;
...
import cn.xzy.framework.common.util.cache.CacheUtils;
import cn.xzy.framework.common.util.http.HttpUtils;
import cn.xzy.framework.common.util.object.BeanUtils;
import cn.xzy.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.xzy.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import cn.xzy.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.xzy.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.xzy.module.system.dal.dataobject.social.SocialClientDO;
import cn.xzy.module.system.dal.mysql.social.SocialClientMapper;
import cn.xzy.module.system.dal.redis.RedisKeyConstants;
import cn.xzy.module.system.enums.social.SocialTypeEnum;
import cn.xzy.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.xzy.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.xzy.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${xzy.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${xzy.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/xzy-cloud/pulls/230
