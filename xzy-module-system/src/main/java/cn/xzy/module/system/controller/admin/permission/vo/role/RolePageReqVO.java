package cn.xzy.module.system.controller.admin.permission.vo.role;
...
public class RolePageReqVO extends PageParam {
    ...
    @Schema(description = "角色标识，模糊匹配", example = "xzy")
    private String code;
    ...
    @Schema(description = "角色编号集合（用于部门隔离过滤，前端无需传入）", hidden = true)
