package cn.xzy.module.member.controller.admin.config;

import cn.xzy.framework.common.pojo.CommonResult;
import cn.xzy.module.member.controller.admin.config.vo.MemberConfigRespVO;
import cn.xzy.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import cn.xzy.module.member.convert.config.MemberConfigConvert;
import cn.xzy.module.member.dal.dataobject.config.MemberConfigDO;
import cn.xzy.module.member.service.config.MemberConfigService;
