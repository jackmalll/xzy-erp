...
import cn.xzy.framework.ip.core.utils.AreaUtils;
import cn.xzy.module.member.api.address.dto.MemberAddressRespDTO;
import cn.xzy.module.member.api.user.dto.MemberUserRespDTO;
...
import cn.xzy.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import cn.xzy.module.product.api.sku.dto.ProductSkuRespDTO;
import cn.xzy.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import cn.xzy.module.product.api.spu.dto.ProductSpuRespDTO;
import cn.xzy.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import cn.xzy.module.trade.api.order.dto.TradeOrderRespDTO;
import cn.xzy.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import cn.xzy.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import cn.xzy.module.trade.controller.admin.order.vo.*;
import cn.xzy.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import cn.xzy.module.trade.controller.app.order.vo.*;
import cn.xzy.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.xzy.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import cn.xzy.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import cn.xzy.module.trade.framework.order.config.TradeOrderProperties;
import cn.xzy.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static cn.xzy.framework.common.util.collection.CollectionUtils.convertMap;
import static cn.xzy.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static cn.xzy.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/xzycode/xzy-mall-uniapp/issues/ICY7SJ
