package cn.xzy.module.iot.gateway.config;

import cn.xzy.module.iot.core.enums.IotProtocolTypeEnum;
import cn.xzy.module.iot.gateway.protocol.coap.IotCoapConfig;
import cn.xzy.module.iot.gateway.protocol.emqx.IotEmqxConfig;
import cn.xzy.module.iot.gateway.protocol.http.IotHttpConfig;
import cn.xzy.module.iot.gateway.protocol.modbus.tcpclient.IotModbusTcpClientConfig;
import cn.xzy.module.iot.gateway.protocol.modbus.tcpserver.IotModbusTcpServerConfig;
import cn.xzy.module.iot.gateway.protocol.mqtt.IotMqttConfig;
import cn.xzy.module.iot.gateway.protocol.tcp.IotTcpConfig;
import cn.xzy.module.iot.gateway.protocol.udp.IotUdpConfig;
import cn.xzy.module.iot.gateway.protocol.websocket.IotWebSocketConfig;
...
@ConfigurationProperties(prefix = "xzy.iot.gateway")
@Validated
@Data
public class IotGatewayProperties {
    ...
    public static class ProtocolProperties {
         ...
         * 协议类型
         *
         * @see cn.xzy.module.iot.core.enums.IotProtocolTypeEnum
         */
         ...
         * 序列化类型（可选）
         *
         * @see cn.xzy.module.iot.core.enums.IotSerializeTypeEnum
         *
         * 为什么是可选的呢？
