package cn.xzy.module.iot.gateway.protocol.emqx.handler.upstream;
...
import cn.xzy.module.iot.gateway.protocol.emqx.IotEmqxProtocol;
    ...
    private void sendRegisterResultMessage(String username, IotDeviceRegisterRespDTO result) {
        ...
        try {
            ...
            byte[] encodedData = deviceMessageService.serializeDeviceMessage(responseMessage,
                    cn.xzy.module.iot.core.enums.IotSerializeTypeEnum.JSON);
            // 1.3 构建响应主题
