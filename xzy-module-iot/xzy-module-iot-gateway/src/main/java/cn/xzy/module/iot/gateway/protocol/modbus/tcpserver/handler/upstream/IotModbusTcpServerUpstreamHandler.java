package cn.xzy.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import cn.xzy.framework.common.exception.ServiceException;
import cn.xzy.framework.common.exception.enums.GlobalErrorCodeConstants;
import cn.xzy.framework.common.pojo.CommonResult;
import cn.xzy.framework.common.util.json.JsonUtils;
import cn.xzy.module.iot.core.biz.IotDeviceCommonApi;
import cn.xzy.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import cn.xzy.module.iot.core.biz.dto.IotDeviceRespDTO;
import cn.xzy.module.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import cn.xzy.module.iot.core.biz.dto.IotModbusPointRespDTO;
import cn.xzy.module.iot.core.enums.IotDeviceMessageMethodEnum;
import cn.xzy.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
import cn.xzy.module.iot.core.mq.message.IotDeviceMessage;
import cn.xzy.module.iot.core.topic.IotDeviceIdentity;
import cn.xzy.module.iot.core.util.IotDeviceAuthUtils;
import cn.xzy.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import cn.xzy.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import cn.xzy.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import cn.xzy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import cn.xzy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import cn.xzy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import cn.xzy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import cn.xzy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import cn.xzy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import cn.xzy.module.iot.gateway.service.device.IotDeviceService;
import cn.xzy.module.iot.gateway.service.device.message.IotDeviceMessageService;
import io.vertx.core.net.NetSocket;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static cn.xzy.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static cn.xzy.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static cn.xzy.framework.common.exception.util.ServiceExceptionUtil.invalidParamException;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link cn.xzy.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
