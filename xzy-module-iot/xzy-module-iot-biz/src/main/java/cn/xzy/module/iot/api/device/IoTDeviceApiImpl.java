package cn.xzy.module.iot.api.device;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import cn.xzy.framework.common.enums.RpcConstants;
...
import cn.xzy.module.iot.core.biz.dto.*;
...
import cn.xzy.module.iot.dal.dataobject.device.IotDeviceModbusConfigDO;
import cn.xzy.module.iot.dal.dataobject.device.IotDeviceModbusPointDO;
import cn.xzy.module.iot.dal.dataobject.product.IotProductDO;
import cn.xzy.module.iot.service.device.IotDeviceModbusConfigService;
import cn.xzy.module.iot.service.device.IotDeviceModbusPointService;
...
@RestController
@Validated
@Primary // 保证优先匹配，因为 xzy-iot-gateway 也有 IotDeviceCommonApi 的实现，并且也可能会被 biz 引入
