...
import cn.xzy.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO;
import cn.xzy.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLineSaveReqVO;
...
import cn.xzy.module.mes.dal.mysql.wm.productsales.MesWmProductSalesLineMapper;
import cn.xzy.module.mes.enums.qc.MesQcCheckResultEnum;
...
import static cn.xzy.module.mes.enums.ErrorCodeConstants.WM_PRODUCT_SALES_LINE_NOT_EXISTS;
...
public class MesWmProductSalesLineServiceImpl implements MesWmProductSalesLineService {
    ...
    @Override
    public cn.xzy.framework.common.pojo.PageResult<MesWmProductSalesLineDO> getProductSalesLinePage(
        ...
        if (pageReqVO.getSalesId() == null && pageReqVO.getClientId() != null) {
            ...
            if (CollUtil.isEmpty(salesList)) {
                return cn.xzy.framework.common.pojo.PageResult.empty();
            }
