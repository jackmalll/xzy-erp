package cn.xzy.module.mes.dal.mysql.wm.productsales;
...
public interface MesWmProductSalesLineMapper extends BaseMapperX<MesWmProductSalesLineDO> {
    ...
    default cn.xzy.framework.common.pojo.PageResult<MesWmProductSalesLineDO> selectPage(
            cn.xzy.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO reqVO) {
        return selectPage(reqVO, new cn.xzy.framework.mybatis.core.query.LambdaQueryWrapperX<MesWmProductSalesLineDO>()
