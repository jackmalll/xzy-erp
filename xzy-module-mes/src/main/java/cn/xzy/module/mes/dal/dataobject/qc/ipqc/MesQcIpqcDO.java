package cn.xzy.module.mes.dal.dataobject.qc.ipqc;
...
import cn.xzy.module.mes.enums.qc.MesQcSourceDocTypeEnum;
...
public class MesQcIpqcDO extends BaseDO {
     ...
     * IPQC 检验类型
     *
     * 字典 {@link cn.xzy.module.mes.enums.DictTypeConstants#MES_IPQC_TYPE}
     */
     ...
     *
     * 关联：根据 {@link #sourceDocType} 不同：
     * 1. {@link MesQcSourceDocTypeEnum#PRO_FEEDBACK} 时，关联 {@link cn.xzy.module.mes.dal.dataobject.wm.productproduce.MesWmProductProduceLineDO#getId()}
     */
     ...
     * 生产任务 ID
     *
     * 关联 {@link cn.xzy.module.mes.dal.dataobject.pro.task.MesProTaskDO#getId()}
     */
    private Long taskId;
    /**
     * 工位 ID
     ...
     * 工序 ID
     *
     * 关联 {@link cn.xzy.module.mes.dal.dataobject.pro.process.MesProProcessDO#getId()}
     */
     ...
     * 检测结果
     *
     * 枚举 {@link cn.xzy.module.mes.enums.qc.MesQcCheckResultEnum}
     */
