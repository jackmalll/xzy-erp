...
import cn.xzy.module.mes.controller.admin.pro.task.vo.MesProTaskIssuePageReqVO;
import cn.xzy.module.mes.controller.admin.pro.task.vo.MesProTaskIssueRespVO;
import cn.xzy.module.mes.controller.admin.pro.task.vo.MesProTaskIssueSaveReqVO;
...
import cn.xzy.module.mes.dal.dataobject.pro.task.MesProTaskIssueDO;
...
import cn.xzy.module.mes.service.pro.task.MesProTaskIssueService;
...
public class MesProTaskIssueController {
    ...
    private List<MesProTaskIssueRespVO> buildIssueRespVOList(List<MesProTaskIssueDO> list) {
        ...
        // 拼接 VO
        return cn.xzy.framework.common.util.collection.CollectionUtils.convertList(list, issue -> {
