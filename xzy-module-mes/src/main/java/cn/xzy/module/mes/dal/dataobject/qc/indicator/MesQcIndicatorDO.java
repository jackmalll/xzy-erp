package cn.xzy.module.mes.dal.dataobject.qc.indicator;
...
public class MesQcIndicatorDO extends BaseDO {
     ...
     * 检测项类型
     *
     * 枚举 {@link cn.xzy.module.mes.enums.DictTypeConstants#MES_INDICATOR_TYPE}
     */
    private String type;
    /**
     * 检测工具
     ...
     * 结果值类型
     *
     * 枚举 {@link cn.xzy.module.mes.enums.qc.MesQcResultValueTypeEnum}
     */
