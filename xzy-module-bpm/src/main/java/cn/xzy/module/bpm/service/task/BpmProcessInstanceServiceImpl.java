package cn.xzy.module.bpm.service.task;
...
import cn.xzy.framework.common.util.date.DateUtils;
import cn.xzy.framework.common.util.json.JsonUtils;
import cn.xzy.framework.common.util.object.ObjectUtils;
import cn.xzy.framework.common.util.object.PageUtils;
import cn.xzy.framework.datapermission.core.annotation.DataPermission;
import cn.xzy.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import cn.xzy.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import cn.xzy.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import cn.xzy.module.bpm.controller.admin.task.vo.instance.*;
import cn.xzy.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import cn.xzy.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.xzy.module.bpm.convert.task.BpmProcessInstanceConvert;
import cn.xzy.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.xzy.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import cn.xzy.module.bpm.enums.ErrorCodeConstants;
import cn.xzy.module.bpm.enums.definition.BpmModelTypeEnum;
import cn.xzy.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import cn.xzy.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import cn.xzy.module.bpm.enums.task.BpmReasonEnum;
import cn.xzy.module.bpm.enums.task.BpmTaskStatusEnum;
import cn.xzy.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import cn.xzy.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import cn.xzy.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import cn.xzy.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import cn.xzy.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import cn.xzy.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import cn.xzy.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import cn.xzy.module.bpm.framework.flowable.core.util.FlowableUtils;
import cn.xzy.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import cn.xzy.module.bpm.service.definition.BpmProcessDefinitionService;
import cn.xzy.module.bpm.service.message.BpmMessageService;
import cn.xzy.module.system.api.dept.DeptApi;
import cn.xzy.module.system.api.dept.dto.DeptRespDTO;
...
import static cn.xzy.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static cn.xzy.module.bpm.enums.ErrorCodeConstants.*;
import static cn.xzy.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static cn.xzy.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/xzy-cloud/issues/ID1UYA
