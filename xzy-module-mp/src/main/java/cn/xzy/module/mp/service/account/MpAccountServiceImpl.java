package cn.xzy.module.mp.service.account;
...
import cn.xzy.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import cn.xzy.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import cn.xzy.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import cn.xzy.module.mp.convert.account.MpAccountConvert;
import cn.xzy.module.mp.dal.dataobject.account.MpAccountDO;
import cn.xzy.module.mp.dal.mysql.account.MpAccountMapper;
import cn.xzy.module.mp.enums.ErrorCodeConstants;
import cn.xzy.module.mp.framework.mp.core.MpServiceFactory;
...
import static cn.xzy.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 xzy-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
