package cn.xzy.module.mp.service.message;
...
import cn.xzy.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import cn.xzy.module.mp.convert.message.MpMessageConvert;
import cn.xzy.module.mp.dal.dataobject.account.MpAccountDO;
import cn.xzy.module.mp.dal.dataobject.message.MpMessageDO;
import cn.xzy.module.mp.dal.dataobject.user.MpUserDO;
import cn.xzy.module.mp.dal.mysql.message.MpMessageMapper;
import cn.xzy.module.mp.enums.message.MpMessageSendFromEnum;
import cn.xzy.module.mp.framework.mp.core.MpServiceFactory;
import cn.xzy.module.mp.framework.mp.core.util.MpUtils;
import cn.xzy.module.mp.service.account.MpAccountService;
import cn.xzy.module.mp.service.material.MpMaterialService;
import cn.xzy.module.mp.service.message.bo.MpMessageSendOutReqBO;
import cn.xzy.module.mp.service.user.MpUserService;
...
import static cn.xzy.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
