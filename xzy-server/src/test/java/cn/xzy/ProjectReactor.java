...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.xzy";
    private static final String ARTIFACT_ID = "xzy";
    private static final String PACKAGE_NAME = "cn.xzy";
    private static final String TITLE = "星之翼管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.xzy";
        String artifactIdNew = "xzy";
        String packageNameNew = "cn.xzy";
        String titleNew = "星之翼管理系统";
