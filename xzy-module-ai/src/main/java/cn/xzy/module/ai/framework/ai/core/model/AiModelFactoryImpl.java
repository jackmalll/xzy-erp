package cn.xzy.module.ai.framework.ai.core.model;
...
import cn.xzy.framework.common.util.spring.SpringUtils;
import cn.xzy.module.ai.enums.model.AiPlatformEnum;
import cn.xzy.module.ai.framework.ai.config.AiAutoConfiguration;
import cn.xzy.module.ai.framework.ai.config.XzyAiProperties;
...
import cn.xzy.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.xzy.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            XzyAiProperties.Midjourney properties = SpringUtil.getBean(XzyAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(XzyAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        XzyAiProperties.DouBao properties = new XzyAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(XzyAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        XzyAiProperties.HunYuan properties = new XzyAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(XzyAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        XzyAiProperties.SiliconFlow properties = new XzyAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(XzyAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        XzyAiProperties.XingHuo properties = new XzyAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(XzyAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        XzyAiProperties.BaiChuan properties = new XzyAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(XzyAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        XzyAiProperties.Gemini properties = SpringUtil.getBean(XzyAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        XzyAiProperties.Grok properties = new XzyAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
