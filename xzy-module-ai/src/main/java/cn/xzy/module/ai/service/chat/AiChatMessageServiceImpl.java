package cn.xzy.module.ai.service.chat;
...
import cn.xzy.framework.tenant.core.util.TenantUtils;
import cn.xzy.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import cn.xzy.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import cn.xzy.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import cn.xzy.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import cn.xzy.module.ai.dal.dataobject.chat.AiChatConversationDO;
import cn.xzy.module.ai.dal.dataobject.chat.AiChatMessageDO;
import cn.xzy.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import cn.xzy.module.ai.dal.dataobject.model.AiChatRoleDO;
import cn.xzy.module.ai.dal.dataobject.model.AiModelDO;
import cn.xzy.module.ai.dal.dataobject.model.AiToolDO;
import cn.xzy.module.ai.dal.mysql.chat.AiChatMessageMapper;
import cn.xzy.module.ai.enums.ErrorCodeConstants;
import cn.xzy.module.ai.enums.model.AiPlatformEnum;
import cn.xzy.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import cn.xzy.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import cn.xzy.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import cn.xzy.module.ai.service.knowledge.AiKnowledgeDocumentService;
import cn.xzy.module.ai.service.knowledge.AiKnowledgeSegmentService;
import cn.xzy.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import cn.xzy.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import cn.xzy.module.ai.service.model.AiChatRoleService;
import cn.xzy.module.ai.service.model.AiModelService;
import cn.xzy.module.ai.service.model.AiToolService;
import cn.xzy.module.ai.util.AiUtils;
import cn.xzy.module.ai.util.FileTypeUtils;
...
import static cn.xzy.framework.common.pojo.CommonResult.error;
import static cn.xzy.framework.common.pojo.CommonResult.success;
import static cn.xzy.framework.common.util.collection.CollectionUtils.convertList;
import static cn.xzy.framework.common.util.collection.CollectionUtils.convertSet;
import static cn.xzy.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static cn.xzy.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 xzy.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 xzy.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
